...
# FROM https://github.com/alevine0/DPA/blob/main/FeatureLearningRotNet/architectures/NetworkInNetwork.py
# Originally proposed in the paper: Network In Network https://arxiv.org/abs/1312.4400
